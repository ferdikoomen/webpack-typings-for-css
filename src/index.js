...
module.exports = function(input) {
    ...
    if (match && match.length) {
        ...
        for (const key in exportLocals) {
            if (Object.prototype.hasOwnProperty.call(exportLocals, key)) {
                locals[toPropName(key)] = exportLocals[key];
            }
        }
        ...
        return input.replace(/exports\.locals = \{[\S\s]*\};/gm, `exports.locals = ${JSON.stringify(locals)};`);
    }
    return input;
};
